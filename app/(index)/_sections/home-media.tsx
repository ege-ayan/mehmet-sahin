      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center gap-12">
          ...
          <div className="relative w-full max-w-4xl flex justify-center">
            ...
            {/* Video Container */}
            <div className="relative aspect-9/16 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10 bg-gray-800 w-full max-w-md">
              {!isReelLoaded ? (
                // Thumbnail with Play Button
                <button
                  onClick={handleLoadReel}
                  className="absolute inset-0 w-full h-full bg-gray-900 hover:bg-gray-800 transition-all duration-300 cursor-pointer group/reel"
                  aria-label="Videoyu oynat"
                >
                  {/* Video as poster - first frame */}
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/videos/katarakt.mp4#t=0.1" type="video/mp4" />
                  </video>

                  {/* Enhanced Dark Overlay */}
                  <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent opacity-80 group-hover/reel:opacity-70 transition-opacity duration-300" />
                ...
                // Video player (Only loads when user clicks)
                <video
                  ...
                  playsInline
                >
                  <source src="/videos/katarakt.mp4" type="video/mp4" />
